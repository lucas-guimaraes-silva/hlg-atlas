# Módulo 1: Fundamentos em Finanças

Esta trilha leva você do zero até conseguir comparar investimentos e entender a bolsa: o que é o mercado financeiro, quem regula o sistema, como funcionam renda fixa, ações, fundos, FIIs, risco, diversificação e macroeconomia.
...
3. [Tesouro Direto](aula-03-tesouro-direto.md)
4. [CDB, LCI, LCA e FGC](aula-04-renda-fixa-bancaria.md)
5. [Ações e bolsa](aula-05-acoes-e-bolsa.md)
6. [Fundos e ETFs](aula-06-fundos-e-etfs.md)
7. [FIIs](aula-07-fiis.md)
...
Depois de concluir este módulo, siga para [Módulo 2: Análise Fundamentalista de Empresas](../modulo-2-analise-fundamentalista/index.md).
