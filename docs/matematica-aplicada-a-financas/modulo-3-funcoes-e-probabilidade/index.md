...
Ao final do módulo, você deve conseguir ler e manipular as fórmulas dos livros de finanças (valor futuro, valor presente, retorno acumulado), resolver "em quanto tempo?" com logaritmos e tomar decisões sob incerteza usando valor esperado.
...
3. [Logaritmos](aula-03-logaritmos.md)
4. [Progressão aritmética (PA)](aula-04-progressao-aritmetica.md)
5. [Progressão geométrica (PG)](aula-05-progressao-geometrica.md)
6. [Somatório (Σ)](aula-06-somatorio.md)
7. [Produtório (Π)](aula-07-produtorio.md)
...
Depois de concluir este módulo, siga para o [Módulo 4 — Estatística e Regressão Linear](../modulo-4-estatistica/index.md).
